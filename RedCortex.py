...
Examples:
  ...
  python RedCortex.py dashboard --port 9090
    ...
    if args.subcommand == 'scan':
        ...
        plugins = args.plugins.split(',') if args.plugins else [p['name'] for p in plugin_manager.list_plugins()]
        
        scanner = EndpointScanner(args.target_url, plugin_manager, threads=args.threads)
